...
public class JournalScreen extends Screen {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.drawString(this.font, "§d❤ Anniversary Journal ❤", startX + (this.bookWidth - this.font.width("❤ Anniversary Journal ❤")) / 2, startY + 20, 0xFF000000, false);
        
        guiGraphics.drawString(this.font, "Partner: §5" + partnerName, startX + 36, startY + 45, 0xFF000000, false);
        guiGraphics.drawString(this.font, "Level: §5" + data.level(), startX + 36, startY + 60, 0xFF000000, false);
        
        guiGraphics.drawString(this.font, "Days Together: §5" + daysTogether, startX + 36, startY + 85, 0xFF000000, false);
        guiGraphics.drawString(this.font, "Kisses Given: §5" + data.kisses(), startX + 36, startY + 100, 0xFF000000, false);
        guiGraphics.drawString(this.font, "Gifts Exchanged: §5" + data.gifts(), startX + 36, startY + 115, 0xFF000000, false);
        guiGraphics.drawString(this.font, "Times Slept Together: §5" + data.sharedBeds(), startX + 36, startY + 130, 0xFF000000, false);
        
        guiGraphics.drawString(this.font, "§8True love lasts forever.", startX + (this.bookWidth - this.font.width("True love lasts forever.")) / 2, startY + 160, 0xFF000000, false);
    }
}
